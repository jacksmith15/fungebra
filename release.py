...
def repo_compare(
    ...
    return (
        ...
        f"fungebra/compare/{old or 'initial'}..{new or 'HEAD'}\n"
    )
...
def github_release_body(current_version: Version, next_version: Version):
    return f"""
[Release Notes](https://github.com/jacksmith15/fungebra/blob/{next_version}/CHANGELOG.md)
[Changes](http://github.com/jacksmith15/fungebra/compare/{current_version}..{next_version})
"""
